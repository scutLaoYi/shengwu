...
echo $this->Form->input('sex',array('label'=>'性别要求','options'=>$allSex));
...
echo $this->Form->input('working_time',array('label'=>'工作时间'));
...
echo $this->Form->input('deadline',array('label'=>'到期时间'));
echo $this->Form->input('detail',array('label'=>'具体要求'));
