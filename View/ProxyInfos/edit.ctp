...
<?php echo $this->Form->create('ProxyInfo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Proxy Info'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProxyInfo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProxyInfo.id'))); ?></li>
